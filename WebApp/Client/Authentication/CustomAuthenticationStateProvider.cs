...
namespace BlazorApp.Client.Authentication
{
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        {
            string token = await _localStorage.GetItemAsStringAsync("token"); //Jwt Token 
            ...
            {
                identity = new ClaimsIdentity(ParseClaimsFromJwt(token), "jwt"); //Parse the Claims from the jwt token 
