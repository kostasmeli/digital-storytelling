...
public static class ProjectSetup
{
    ...
    static void ImportEssentials()
    {
        ...
        // Add Assets that i find useful to the project
    }
    ...
    public static void CreateFolders() {
        Folders.Create("_Project", "Animation", "Art", "Materials", "Prefabs", "Scripts/Tests", "Scripts/Tests/Editor", "Scripts/Tests/Runtime", "Audio", "ScriptableObjects", "Shaders");
        Refresh();
